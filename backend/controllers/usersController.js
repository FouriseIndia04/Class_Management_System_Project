...
import { Student, Teacher } from "../models/usersSchema.js"; // Combined imports

export const adminSignIn = async (req, res, next) => {
  const { email, password } = req.body;
  try {
    if (!email || !password) {
      return handleValidationError("Please provide email and password", 400); // Ensure error handling function returns
    }
